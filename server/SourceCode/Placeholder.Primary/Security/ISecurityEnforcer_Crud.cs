...
namespace Placeholder.Primary.Security
{
    ...
    public partial interface ISecurityEnforcer
    {
        ...
        void ValidateCanCreate(Account currentAccount, Widget widget);
        void ValidateCanSearchWidget(Account currentAccount, Guid? shop_id = null);
        void ValidateCanListWidget(Account currentAccount, Guid? shop_id = null);
        void ValidateCanRetrieve(Account currentAccount, Widget widget);
        void ValidateCanUpdate(Account currentAccount, Widget widget);
        void ValidateCanDelete(Account currentAccount, Widget widget);
