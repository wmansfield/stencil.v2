...
namespace Placeholder.Web.Controllers
{
    ...
    /// </summary>
    public abstract class HealthPlaceholderController : PlaceholderController
    {
        public HealthPlaceholderController(IFoundation foundation, string trackPrefix)
            : base(foundation)
        {
            this.TrackPrefix = trackPrefix;
        }
        public HealthPlaceholderController(IFoundation foundation, IHandleExceptionProvider iHandleExceptionProvider, string trackPrefix)
